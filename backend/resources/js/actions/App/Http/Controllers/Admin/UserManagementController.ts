 ...
 * @see app/Http/Controllers/Admin/UserManagementController.php:13
 * @route '/admin/users'
 */
 ...
 * @see app/Http/Controllers/Admin/UserManagementController.php:30
 ...
 * @see app/Http/Controllers/Admin/UserManagementController.php:39
 * @route '/admin/users'
 */
 ...
 * @see app/Http/Controllers/Admin/UserManagementController.php:69
 ...
 * @see app/Http/Controllers/Admin/UserManagementController.php:88
 * @route '/admin/users/{user}'
 */
...
const UserManagementController = { index, create, store, show, edit, update, destroy }
