...
const EditSupplier: React.FC = () => {
  ...
  const fetchSupplier = async () => {
    try {
      setIsFetching(true);
      const response = await SupplierAPI.getSupplier(Number(id));
      const supplier = response.data.success ? response.data.data : response.data;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsLoading(true);
      const response = await SupplierAPI.updateSupplier(Number(id), formData);
